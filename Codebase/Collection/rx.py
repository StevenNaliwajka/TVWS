...
def main() -> int:
    ...
    ap.add_argument("--lna", type=int, default=30, help="LNA gain (hackrf_transfer -l). Default 16")
    ap.add_argument("--vga", type=int, default=30, help="VGA gain (hackrf_transfer -g). Default 16")
