...
def upper_filter(meta_data, iq):
    """
    Returns a function that filters OUT everything ABOVE the highest of (sync_hz, signal_tx_hz).
    I.e., keeps frequencies <= highest_freq.

    Usage:
        f = filter_upper_freq(MetaDataObj)
        iq2 = f(iq)
    """
