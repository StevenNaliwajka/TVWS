...
class HackRFAnalysis(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "HackRFAnalysis")
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, '/home/kevin/PycharmProjects/TVWS/data/OneDrive_1_12-2-2025/10 Feet/20251119_23-24-44_1763612684_rx2_10ft14030_tx044.iq', True, 0, 0)
        ...
        self.connect((self.blocks_char_to_float_1, 0), (self.blocks_float_to_complex_0, 1))
...
def main(top_block_cls=HackRFAnalysis, options=None):
